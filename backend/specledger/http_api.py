...
async def unhandled_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    # A custom @app.middleware("http") (BaseHTTPMiddleware) sits between
    # CORSMiddleware and the router, which is known to drop CORS headers on
    # responses generated by exception handlers. Add them explicitly here so
    # a 500 doesn't masquerade as a CORS failure in the browser.
